        ...
        <div class="panel panel-default content-main">
            <form name="question" method="post" action="/users/update">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" userId="name" name="name" placeholder="Name" value="${user.name}">
                </div>
                <div class="form-group">
                    <label for="email">이메일</label>
                    <input type="email" class="form-control" userId="email" name="email" placeholder="Email" value="${user.email}">
                </div>
